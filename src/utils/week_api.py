...
def get_nfl_current_week_number(api_key: str = "69c2e9d1866745c6a493fb2c255c51bf") -> Optional[int]:
    """
...
def get_nfl_previous_week_number(api_key: str = "69c2e9d1866745c6a493fb2c255c51bf") -> Optional[int]:
    """
    ...
    """
    current_week = get_nfl_current_week_number(api_key)
...
if __name__ == "__main__":
    current_week = get_nfl_current_week_number()
    previous_week = get_nfl_previous_week_number()
